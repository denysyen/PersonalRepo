...
public class SimpleCorsFilter  implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        reponse.setHeader("Access-Control-Allow-Origin", originHeader);
        reponse.setHeader("Access-Control-Allow-Methods", "GET, POST, UPDATE, DELETE");
        reponse.setHeader("Access-Control-Allow-Max-Age", "3600");
